class StripeAccountsController < ApplicationController
  ...
  def create
    ...
    if current_user.save
      ...
      redirect_to new_bank_account_path, alert: "Your account is created!"
    else
      flash[:error] = "Account cannot be created"
      render 'new' , alert: "Account cannot be created"
    end
    ...
    flash[:error] = "Cannot create Account"
